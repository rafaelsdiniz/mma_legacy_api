...
public static class AcervoDeLutadores
{
    ...
    [
        ...
        Criar("Anderson Silva", "Brasil", 97, 92, 90, 74, 88, 84, 86, 96),
        Criar("Alex Pereira", "Brasil", 96, 99, 87, 75, 76, 87, 92, 93),
        Criar("José Aldo", "Brasil", 94, 91, 95, 84, 82, 82, 88, 93),
        Criar("Charles Oliveira", "Brasil", 88, 89, 84, 78, 99, 88, 84, 87),
        Criar("Amanda Nunes", "Brasil", 93, 95, 88, 87, 88, 84, 87, 91),
        Criar("Maurício Rua", "Brasil", 89, 91, 83, 79, 84, 78, 82, 82),
        Criar("Antônio Rodrigo Nogueira", "Brasil", 78, 80, 70, 76, 96, 84, 95, 89),
        Criar("Vitor Belfort", "Brasil", 88, 95, 93, 70, 82, 70, 78, 76),
        Criar("Deiveson Figueiredo", "Brasil", 87, 92, 85, 82, 88, 78, 84, 83),
        Criar("Glover Teixeira", "Brasil", 82, 86, 74, 86, 90, 80, 86, 85),

        Criar("Khabib Nurmagomedov", "Rússia", 78, 80, 84, 99, 90, 94, 92, 95),
        Criar("Islam Makhachev", "Rússia", 84, 82, 85, 96, 92, 93, 90, 94),
        Criar("Fedor Emelianenko", "Rússia", 88, 94, 86, 88, 90, 82, 90, 90),
        ...
        Criar("Daniel Cormier", "Estados Unidos", 84, 88, 80, 96, 84, 86, 92, 93),
        Criar("Kamaru Usman", "Estados Unidos", 88, 87, 82, 96, 80, 92, 90, 92),
        Criar("Jordan Burroughs", "Estados Unidos", 60, 70, 88, 99, 72, 90, 84, 88),
        Criar("Henry Cejudo", "Estados Unidos", 86, 82, 90, 97, 76, 90, 84, 92),
        Criar("Randy Couture", "Estados Unidos", 76, 78, 70, 94, 78, 84, 90, 94),
        Criar("Cain Velasquez", "Estados Unidos", 86, 90, 84, 95, 80, 96, 86, 88),
        ...
        Criar("Georges St-Pierre", "Canadá", 90, 82, 90, 96, 88, 94, 90, 99),
        Criar("Demetrious Johnson", "Estados Unidos", 88, 76, 96, 92, 90, 95, 82, 97),
        Criar("Conor McGregor", "Irlanda", 92, 97, 92, 66, 72, 72, 78, 88),
        Criar("Michael Bisping", "Reino Unido", 86, 74, 82, 80, 76, 92, 90, 88),
        Criar("Leon Edwards", "Reino Unido", 89, 84, 86, 82, 82, 90, 86, 89),
        Criar("Israel Adesanya", "Nigéria", 96, 90, 92, 64, 70, 86, 84, 94),
        Criar("Francis Ngannou", "Camarões", 82, 100, 84, 74, 68, 70, 84, 78),
        ...
        Criar("Zabit Magomedsharipov", "Rússia", 90, 82, 90, 86, 92, 84, 82, 86)
    ];
